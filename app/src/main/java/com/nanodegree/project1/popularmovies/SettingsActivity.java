...
/**
 * Created by Koushick on 03-09-2016.
 */
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class MoviePreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener
    {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference mostPopular = findPreference(getString(R.string.settings_order_by_key));
            bindPreferenceSummaryToValue(mostPopular);
        }
